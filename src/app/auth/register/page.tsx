  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: `${window.location.origin}/convert`,
      ...
      if (error) {
        ...
        showNotification('success', 'Đăng ký thành công! Vui lòng kiểm tra email để xác nhận.');
        setEmail("");
        setPassword("");
        setConfirmPassword("");
        setCaptchaToken(null);
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-[94%] max-w-2xl rounded-[28px] border border-white/30 bg-white/10 backdrop-blur-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] p-8 sm:p-12" style={{
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-[var(--text-primary)] mb-6">Create Account</h1>
